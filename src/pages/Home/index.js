        ...
        <View style={{flex: 1}}>
            <ScrollView style={{flex: 1, backgroundColor: 'white'}}>
                ...
                <View style={{marginHorizontal: 17, marginTop: 20}}>
                    <View>
                        <View style={{backgroundColor: '#2c5fbb', borderTopLeftRadius: 6, borderTopRightRadius: 6, padding: 12}}>
                            <Text style={{color: 'white', fontSize: 16, fontWeight: 'bold'}}>Explore REMAN NEWS</Text>
                        </View>
                    </View>
                    <View style={{flexDirection: 'row', paddingTop: 20, paddingBottom: 18, backgroundColor: '#2f65bd'}}>
                ...
                <View style={{paddingTop: 16, paddingHorizontal: 16}}>
                    <Text style={{fontSize: 18, fontWeight: 'bold', alignSelf: 'center'}}>Berita Terkini</Text>
                    <View style={{position: 'relative', paddingTop: 12}}>
                        <Image source={require('../../assets/image/Succes.jpg')} style={{height: 170, width: '100%', borderRadius: 6}} />
                        <View style={{width: '100%', height: '100%', position: 'absolute', top: 12, left: 0, backgroundColor: 'black', opacity: 0.13, borderRadius: 6}}></View>
                    </View>
                    <View style={{paddingTop: 16, paddingBottom: 20, borderBottomColor: '#e8e9ed', borderBottomWidth: 1, marginBottom: 20}}>
                        <Text style={{fontSize: 16, fontWeight: 'bold', color: '#1c1c1c'}}>REMAN NEWS</Text>
                        <Text style={{fontSize: 14, fontWeight: 'normal', color: '#7a7a7a', marginBottom: 12}}>New normal atau kebiasaan baru akan diterapkan mulai Agustus 2020 di Indonesia</Text>
                        <TouchableOpacity style={{backgroundColor: '#1bc900', paddingHorizontal: 12, paddingVertical: 11, alignSelf: 'flex-end', borderRadius: 5}}>
